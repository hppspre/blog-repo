        ...
        <div class="col-md-6 justify-content-center">
            <div class="card">
                ...
                <div class="card-body justify-content-center">
                    ...
                    <form method="POST" action="{{ route('update-user-post') }}" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{ route('update-user-post-image') }}" enctype="multipart/form-data">
            @csrf
